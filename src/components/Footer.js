...
const Footer = () => {
    return (
        ...
        <div className="container mx-auto text-black-500   ">
            <div className="flex justify-center bg-[#FFEFE6] ">
                ...
                <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="subscribe w-full md:w-[40%] p-[4rem] ">
                        ...
                        <div className="box bg-[#3E2C34] text-white p-5 rounded-lg relative md:h-[14rem] ">
                        ...
                        <div className="footer-links flex justify-center md:justify-end  mt-10">
                            <div className="mr-3">
